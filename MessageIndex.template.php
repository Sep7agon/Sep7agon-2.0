...
function template_main()
{
	...
	<div class="tborder topic_table" id="messageindex">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			// Give them the replies...
			echo '<span style="color: #BBBBBB; margin: 0 3px 0 0;"> | ', $topic['replies'], ' replies</span> ';

			// Is this topic new? (assuming they are logged in!)
			if ($topic['new'] && $context['user']['is_logged'])
					echo '
							<a href="', $topic['new_href'], '" id="newicon' . $topic['first_post']['id'] . '"><img src="', $settings['lang_images_url'], '/new.png" alt="', $txt['new'], '" /></a>';

			/*if(!empty($modSettings['like_post_enable']) && !empty($modSettings['lp_show_like_on_boards']) && LP_isAllowedTo(array('can_like_posts', 'can_view_likes', 'can_view_likes_in_boards'))) {
